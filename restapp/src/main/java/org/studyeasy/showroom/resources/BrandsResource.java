...
public class BrandsResource {
	...
	public Brand getBrand(@PathParam("brandId") int brandId, @Context UriInfo uri) {
		...
		String productsUri = uri.getBaseUriBuilder().path(ProductsResource.class)//base uri is homepage link . this is for class level
				.path(ProductsResource.class, "getProductsByBrand")//this is for method level
				.resolveTemplate("brandId", brandId).toString();//this is for variable
